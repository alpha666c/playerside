...
export default async function WageringBonusPage({ params: paramsPromise }: Args) {
      ...
      <div className="container max-w-[720px]">
        ...
        <dl className="m-0 grid gap-x-6 gap-y-5 rounded-[var(--radius)] border border-line bg-dusk p-6 font-mono text-[13px] sm:grid-cols-2 sm:p-7">
          <div>
            ...
            <dd className="m-0 text-lg text-gold">{bonus.wageringMultiplier}×</dd>
          </div>
          <div>
            <dt className="text-[10.5px] uppercase tracking-[1.5px] text-paper-dim/70">
              Applies to
            ...
            <dd className="m-0 text-paper">
              {bonus.wageringAppliesTo === 'bonus_only' ? 'Bonus amount only' : 'Bonus + deposit combined'}
            </dd>
          </div>
          <div>
            <dt className="text-[10.5px] uppercase tracking-[1.5px] text-paper-dim/70">
            ...
            <dd className="m-0 text-paper">{bonus.wageringTimeLimit}</dd>
          </div>
          <div>
            <dt className="text-[10.5px] uppercase tracking-[1.5px] text-paper-dim/70">
              Max withdrawal
          ...
          <div className="sm:col-span-2">
            <dt className="mb-2 text-[10.5px] uppercase tracking-[1.5px] text-paper-dim/70">
              Contributing games
            </dt>
            <dd className="m-0 flex flex-wrap gap-2">
              {bonus.contributingGames?.map((g, i) => (
                <span
                  className="rounded-full border border-line px-2.5 py-1 text-paper"
                  key={i}
                >
