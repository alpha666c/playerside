...
const baseClasses =
  'inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 font-sans text-[14.5px] font-semibold transition-[transform,translate,box-shadow,border-color] duration-fast ease-quart'
